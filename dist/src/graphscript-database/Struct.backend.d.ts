...
export declare class StructBackend extends Service {
    ...
    getMongoUser: (user: Partial<ProfileStruct>, info?: string, requireAuth?: boolean, basicInfo?: boolean, token?: string) => Promise<undefined | {} | {
        user: ProfileStruct;
    ...
    queryUsers: (user: Partial<ProfileStruct>, info?: string, limit?: number, skip?: number, requireAuth?: boolean, token?: string) => Promise<undefined | {} | {
        user: ProfileStruct;
        authorizations: AuthorizationStruct[];
        groups: GroupStruct[] | {
            user: ProfileStruct;
